...
float g_iaDiscColors[33][3] =
{
	...
	{ 128, 0, 128 },
	{ 0, 128, 128 },
	{ 250, 160, 0 },//{ 128, 128, 128 }, // Wha? - Switched colours around to stop team 7 from looking like team 1
	{ 64, 128, 0 },
	{ 0, 250, 128 },//{ 128, 64, 0 }, // previous colour 
	{ 128, 0, 64 },
	{ 64, 0, 128 },
	{ 0, 64, 128 },//12 - team number
	{ 64, 64, 128 },
	{ 128, 64, 64 },
	{ 64, 128, 64 },
	{ 128, 128, 64 },
...
void CDisc::Spawn()
{
	...
	m_iBounces = 0;
	m_fDontTouchOwner = gpGlobals->time + 0.2f;
	...
	if (m_bDecapitate)
		EMIT_SOUND( ENT(pev), CHAN_VOICE, "weapons/rocket1.wav", 0.5f, 0.5f );
...
/*
void CDisc::SetObjectCollisionBox()
{
...
void CDisc::DiscTouch ( CBaseEntity *pOther )
{
	...
	if ( pOther->IsPlayer() )
	{
		CBasePlayer *pPlayer = (CBasePlayer *)pOther; //Wha? - Spawn Protection
