...
void CDiscwarPowerup::SetObjectCollisionBox()
{
...
void CDiscwarPowerup::AnimateThink()
{
	StudioFrameAdvance();
	pev->nextthink = gpGlobals->time + 0.1f;
}
...
void CDiscwarPowerup::RemovePowerupThink()
{
...
void CBasePlayer::RemoveAllPowerups()
{
	m_iPowerups = 0;
	m_iPowerupDiscs = 0;
