...
// dont let uninitialized value here hurt the player
	...
	//Comment out SET_MODEL to see if it defaults - desNotes
...
{
	//Change to Rico model - desNotes
	//PRECACHE_MODEL("models/player/male/female.mdl");
	//SET_MODEL(ENT(pev), "models/player/male/female.mdl");	
